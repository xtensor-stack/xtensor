...
namespace xt
{
    ...
    TEST(xstrided_view, simple)
    {
        ...
        auto view1 = strided_view(a, slice_vector({ 1, range(1, 4) }));
        ...
        auto view2 = strided_view(a, slice_vector({ range(0, 2), 2 }));
    ...
    TEST(xstrided_view, iterator)
    {
        ...
        auto view2 = strided_view(view1, slice_vector({ range(0, 2), range(1, 3) }));
    ...
    TEST(xstrided_view, xstrided_view_on_xfunction)
    {
        ...
        auto sum = a + b;
        auto func = strided_view(sum, slice_vector({ 1, range(1, 4) }));
    ...
    {
        auto vgen = strided_view(eye(4), slice_vector({ 1, range(1, 4) }));
    ...
    TEST(xstrided_view, newaxis)
    {
        ...
        auto view1 = strided_view(a, slice_vector({ all(), newaxis(), all() }));
        ...
        auto view3 = strided_view(a, slice_vector({ 1, newaxis(), all() }));
        EXPECT_EQ(a(1, 1), view3(0, 1));
        EXPECT_EQ(a(1, 2), view3(0, 2));
        EXPECT_EQ(size_t(2), view3.dimension());

        auto view4 = strided_view(a, slice_vector({ 1, all(), newaxis() }));
    ...
    TEST(xstrided_view, newaxis_iterating)
    {
        ...
        auto view1 = strided_view(a, slice_vector({ all(), all(), newaxis() }));
        ...
        auto view2 = strided_view(a, slice_vector({ all(), newaxis(), all() }));
        auto iter2 = view2.template begin<layout_type::row_major>();
    ...
    TEST(xstrided_view, newaxis_function)
    {
        ...
        auto v = strided_view(b, slice_vector({ newaxis(), all() }));
    ...
    TEST(xstrided_view, range_adaptor)
    {
        ...
        auto v1 = strided_view(a, slice_vector({ range(3, _) }));
        t v1e = { 4, 5 };
        EXPECT_TRUE(v1e == v1);

        auto v2 = strided_view(a, slice_vector({ range(_, 2) }));
        t v2e = { 1, 2 };
        EXPECT_TRUE(v2e == v2);

        auto v3 = strided_view(a, slice_vector({ range(n, n) }));
        t v3e = { 1, 2, 3, 4, 5 };
        EXPECT_TRUE(v3e == v3);

        auto v4 = strided_view(a, slice_vector({ range(n, 2, -1) }));
        t v4e = { 5, 4 };
        EXPECT_TRUE(v4e == v4);

        auto v5 = strided_view(a, slice_vector({ range(2, n, -1) }));
        t v5e = { 3, 2, 1 };
        EXPECT_TRUE(v5e == v5);

        auto v6 = strided_view(a, slice_vector({ range(n, n, n) }));
        t v6e = { 1, 2, 3, 4, 5 };
        EXPECT_TRUE(v6e == v6);

        auto v7 = strided_view(a, slice_vector({ range(1, n, 2) }));
        t v7e = { 2, 4 };
        EXPECT_TRUE(v7e == v7);

        auto v8 = strided_view(a, slice_vector({ range(2, n, 2) }));
        t v8e = { 3, 5 };
        EXPECT_TRUE(v8e == v8);
    }
    ...
    TEST(xstrided_view, assign)
    {
        ...
        auto v = strided_view(a, slice_vector({ range(0, 2) }));
        v = 1000;
        EXPECT_EQ(v(0), 1000);
        EXPECT_EQ(a(0), 1000);
        EXPECT_EQ(a(1), 1000);

        auto v2 = strided_view(a, slice_vector({ range(3, 5) }));
        t b = { -100, -100 };
        v2 = b;
        EXPECT_EQ(v2(1), -100);
        EXPECT_EQ(a(4), -100);
