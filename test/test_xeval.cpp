  ...
  EXPECT_TRUE(detail::is_array<                                      \
    ...
    { // avoid collision with fixture class
        ...
        TEST_CASE("as_strided")
        {
            ...
            SUBCASE("array_layout_unchanged")
            {
            ...
            SUBCASE("tensor_layout_unchanged")
            {
            ...
            SUBCASE("array_no_data_interface_layout_unchanged")
            {
            ...
            SUBCASE("tensor_no_data_interface_layout_unchanged")
            {
            ...
            SUBCASE("array_no_data_interface_layout_changed")
            {
                auto array_cast = xt::cast<int>(arr);
                EXPECT_FALSE(HAS_DATA_INTERFACE(array_cast));
                EXPECT_XARRAY(array_cast);
            ...
            SUBCASE("tensor_no_data_interface_layout_changed")
            {
                auto tensor_cast = xt::cast<int>(ten);
                EXPECT_FALSE(HAS_DATA_INTERFACE(tensor_cast));
                EXPECT_XTENSOR(tensor_cast);
