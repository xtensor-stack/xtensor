...
namespace xt
{
    ...
    TEST_CASE_TEMPLATE("container_semantic", TypeParam, xarray_dynamic, xtensor_dynamic)
    {
        SUBCASE("a_plus_b")
        {
        ...
        SUBCASE("assign_a_bitwise_and_b")
        {
            operation_tester<std::bit_and<>, TypeParam> tester;
        ...
        SUBCASE("assign_a_bitwise_xor_b")
        {
            operation_tester<std::bit_xor<>, TypeParam> tester;
