...
namespace xt
{
    ...
    TEST(xdynview, iterator)
    {
        ...
        auto view1 = dynview(a, {range(0, 2), 1, range(1, 4)});
        ...
        auto view2 = dynview(view1, {range(0, 2), range(1, 3)});
    ...
    TEST(xdynview, xdynview_on_xfunction)
    {
        ...
        auto func = dynview(a, {1, range(1, 4)}) + b;
    ...
    TEST(xdynview, newaxis)
    {
        ...
        auto view1 = dynview(a, {all(), newaxis(), all()});
        ...
        auto view2 = dynview(a, {all(), all(), newaxis()});
    ...
    TEST(xdynview, newaxis_iterating)
    {
        ...
        auto view1 = dynview(a, {all(), all(), newaxis()});
        ...
        auto view2 = dynview(a, {all(), newaxis(), all()});
        auto iter2 = view2.begin();
