...
namespace xt
{
    ...
    public:
        ...
        using derived_type = typename base_type::derived_type;
        using base_type::derived_cast;
        using inner_shape_type = typename xiterable_inner_types<D>::inner_shape_type;

        constexpr inline const inner_shape_type& shape() const noexcept;
    ...
    constexpr inline auto shape() const noexcept
