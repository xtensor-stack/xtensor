...
namespace xt
{
    ...
    namespace detail
    {
        ...
        template <class F, class T, int N, layout_type L>
        struct functorview_temporary_type_impl<F, tiny_array<T, N>, L>
        {
            using type = xtensor<typename F::value_type, N, L>;
        };

        template <class F, class T, layout_type L>
        struct functorview_temporary_type_impl<F, tiny_array<T, runtime_size>, L>
        {
            using type = xarray<typename F::value_type, L>;
        };
    }
