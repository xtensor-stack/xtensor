...
namespace xt
{
    ...
    private:
        ...
        template <class EC2, size_t N1, size_t N2, layout L1>
    ...
    template <template <class, size_t, layout> class C, class EC, size_t N1, size_t N2, layout L>
    ...
    template <class EC, size_t N1, size_t N2, layout L1>
