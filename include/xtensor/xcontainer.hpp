...
#undef DL
    ...
    {
        return derived_cast().container_shape_impl();
    }
    ...
    {
        return contiguous_layout ? storage().size() : compute_size(derived_cast().shape());
    }
    ...
    {
        return derived_cast().derived_cast().shape();
    }
    */
    ...
    */
    ...
    {
        return xt::broadcast_shape(derived_cast().shape(), shape);
    }
