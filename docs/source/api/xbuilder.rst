...
.. doxygenfunction:: xt::full_like(const I (&)[L])
   :project: xtensor

.. doxygenfunction:: xt::empty_like(const I (&)[L])
   :project: xtensor

.. doxygenfunction:: xt::zeros_like(const I (&)[L])
   :project: xtensor

.. doxygenfunction:: xt::ones_like(const I (&)[L])
   :project: xtensor
